...
getXrdb = readFile "/home/bruno/.walxrvals"
...
myLayoutHook = smartBorders $ avoidStruts $ spiral (6/7) ||| Full
--myLayoutHook = smartBorders $ avoidStruts $ Tall 1 (3 / 100) (1 / 2) ||| spiral (6 / 7) ||| Full
--
...
myConfig colVals logHandle = def
        { terminal    = "urxvt"
        , modMask     = mod4Mask
        , borderWidth = 3
        ...
        , handleEventHook = fullscreenEventHook <+> handleEventHook def <+> docksEventHook
